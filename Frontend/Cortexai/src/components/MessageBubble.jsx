...
function MessageBubble({ role, content, images }) {
    ...
    return (
        <div className={`flex mt-5 ${isUser ? 'justify-end' : 'justify-start'}`}>
            <div
                className={`max-w-[72%] px-4 py-2.5 rounded-2xl text-[13.5px] leading-relaxed ${
                    isUser
                        ? "bg-linear-to-br from-indigo-500 to-violet-700 text-white rounded-t-sm"
            ...
            >
                ...
                <Markdown
                    ...
                    components={{
                        ...
                        table: ({ children }) => (
                            <div className="min-w-full border border-white/10">
